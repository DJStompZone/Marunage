...
(function() {
  var Mailer, TIMEOUT_MS, app, bodyParser, configs, cookieParser, cors, createHTMLForMail, express, fs, hscert, hskey, http, https, httpsOptions, methodOverride, morgan, myUtil, path, request, sendMail, servser, util;
